...
import DescargarEntrePisos from '../assets/DescargarEntrePisos.png'
...
const Download = () => {
  ...
  return (
    <Container id="descargar">
      <Grid2 container spacing={4} sx={{ paddingTop: '7rem', display: 'flex', 
          alignItems: 'center' }}>
        ...
        <Box
            component="img"
            src={DescargarEntrePisos}
            alt="Descargar la aplicación EntrePisos."
            sx={{
              width: { xs: '100%', md: '100%', lg: '110%' },
